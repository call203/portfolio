export const Experiences = [
  {
    ...
    jobs: ["React/React Native 개발", "프론트엔드 리드"],
    links: [{ title: "title1", link: "https://www.naver.com" }]
    // detail: [
    //   {
    //     title: "프론트엔드 리드 및 다중 플랫폼 앱 개발",
    //     info: "스타트업 환경에서 프론트엔드 개발을 전반적으로 리드하며, iOS와 Android 두 플랫폼에서 동시 운영되는 React Native 기반 애플리케이션을 신속하게 개발 및 출시. 이를 통해 다양한 기기에서 일관된 사용자 경험 제공."
    //   },
    //   {
    //     title: "실시간 GPS추적 시스템 구축",
    //     info: "지속적인 GPS 추적을 위한 실시간 데이터 처리 시스템을 구축하여 사용자 활동을 정확하게 기록하고, 실시간 피드백을 제공. 이를 통해 러닝 애플리케이션 핵심 기능인 실시간 위치 추적의 안정성과 정확도를 크게 향상 시킴."
    //   },
    //   {
    //     title: "게임화된 애니메이션 효과 적용",
    //     info: "동적인  UI 요소와 시각적 피드백을 제공해 사용자 참여를 유도하고 사용자 인터페이스를 직관적으로 개선하여 사용자 만족도를 크게 향상시킴."
    //   },
    //   {
    //     title: "외부 API통합으로 기능 확장",
    //     info: "Garmin 서비스 같은 외부 서비스와의 API 통합을 통해 애플리케이션의 기능을 확장하고, 사용자 맞춤형 실시간 데이터를 제공하는 시스템을 구축."
    //   }
    // ]
  }
  // {
  ...
  //   job: ["인턴", "React 개발", "Flask 이용한 검색기능"],
  //   detail: [
  //     {
  //       title: "관리자 웹 페이지 기능 개발",
  //       info: "React를 이용해 관리자 제품 검색 및 등록 기능을 구축하여 운영 효율성을 개선."
  //     },
  //     {
  //       title: "검색 기능 구축",
  //       info: "Flask를 통해 대용량 데이터를 효율적으로 검색할 수 있는 기능을 구축하고, 이를 React Native 애플리케이션에 통합하여 사용자에게 신속한 데이터 검색 서비스를 제공."
  //     }
  //   ]
  // }
];
